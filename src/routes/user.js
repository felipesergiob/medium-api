...
export default class UserRoutes extends BaseRoutes {
	...
	setup() {
		...
		this.router.get("/profile/:id",  this.SchemaValidator.validate(UserSchema.getProfile), AuthMiddleware.isAuthorized, this.userController.read.bind(this.userController));
